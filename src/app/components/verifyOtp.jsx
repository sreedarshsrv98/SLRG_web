            ...
            {[
              ...
              >
                <div className="flex flex-col items-center">
                  ...
                  <div className="text-[13px] font-mulish font-medium text-gray-700 text-center mb-1">
                    {label}
                  </div>
                  <div className="text-[18px] font-bold font-mulish text-[#039123]">
                    {count}
                  </div>
                </div>
              </div>
