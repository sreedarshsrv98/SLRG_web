...
export default function ToggleButton() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[95vw] sm:max-w-[636px] h-auto sm:h-[60px] rounded-[40px] bg-[rgba(206,245,215,1)] p-1">
      ...
      {/* Active background block (same green color) */}
      {/* <div
        className={`absolute top-[5px] left-[5px] h-[50px] w-[208px] rounded-[40px] transition-all duration-300 ease-in-out bg-[rgba(3,145,35,1)]`}
        style={{ transform: `translateX(${activeIndex * 212}px)` }}
      /> */}
 <div
