...
export default function CompanyDetails() {
  return (
    <>
 <div
  // className="relative w-full max-w-[1128px] mx-auto rounded-[20px] gap-[10px] px-4 sm:px-5 md:px-8 p-[16px] sm:p-[20px] md:p-[32px]"
        className="relative h-auto rounded-[20px] gap-[10px] mx-4 sm:mx-6 md:mx-auto px-4 max-w-[1118px] py-5 mb-0 sm:mb-15"
  style={{
...
>
      ...
      <div className="min-h-[50vh] flex items-center justify-center mt-4">
        <div
